...
| **Until Midnight** | `10:00 - 24:00` or `10:00 - 00:00` | Shop operates until the end of the day. |
| **24/7 (Non-stop)** | `00:00 - 24:00` or `00:00 - 00:00` or `24:00 - 00:00` | Shop is open all day. |
...
* **User data:** To make it easy and consistent for the user, all inputs like `24:00` should be considered to be `00:00` or `midnight`.
